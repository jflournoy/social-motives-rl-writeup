...
As such, the distribution of the _p_-value of the generating parameters (in relation to the posteriors) should be uniform (for the same reason that _p_-values are expected to be uniform if the nil null hypothesis is true).
...
@peters2017 report on a longitudinal sample with 736 observations over 3 waves, with participants age 8-25 years.
These two robust studies both report results that are consistent with improvements in performance on reinforcement learning tasks across adolescence.

### Performance differences across development

The most consistent finding from this literature, and which is consistent with the present study, is that adults, or young adults, perform better than adolescents or children [@duijvenvoorde2008; @decker2015; @bos2009; @cohen2010; @christakou2013; @palminteri2016; @rosenblau2017; @peters2017; @mccormick2017].
In one study, adolescents performed better than adults, which was interpreted as indicating that heightened reward sensitivity may lead to better learning during adolescence [@davidow2016].
Like many of the studies which show greatest performance during adulthood, these authors used a probabilistic reinforcement learning task.
...
The only study in which this relation is reversed was that reported by @davidow2016, though another study showed differently signed relations between learning rates for positive versus negative feedback [@christakou2013].
