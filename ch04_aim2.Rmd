...
Inclusion of age and gender covariates, as well as interpretation of associations will procede as described in the previous subsection.
...
Including the association with Sociability resulted in significant fit differences for both the college ($`r print_lrt_test_stats(ksrq_alc_5drnk_admrtn_lrt,2,3)`$) and full sample ($`r print_lrt_test_stats(ksrq_alc_5drnk_admrtn_all_lrt,2,6)`$). In both cases, freeing the Sociability coefficient resulted in a negative Admiration coefficient with smaller magnitude than the models excluding Sociability.
...
- Scale validation
  - Inter-scale correlations
    ...
    - Interpretting the meaning of the K-SRQ variables is made difficult by the extremely high correlations among the factors. 
- Cross sectional
...
- SPLT task validation
  - Self report relation to SPLT
    - Baseline performance showed small but theoretically sensible correlations with a number of self-report scales. Interestingly, correlations with specific model parameters may indicate that the psychological causes of performance differences differ by self-report scale (Cite WOUTER).
    - The primary measures of core impulsivity showed negative relations with performance, while sensation-seeking, in the college sample, was slightly positively correlated with performance, perhaps relfecting a shared effect of maturity in this sample.
    - Although it is quite possibly spurious, if there is a true negative relation between the noise parameter, $\xi$ and the three K-SRQ scales (Sexual Relationships, Sociability, and Admiration), it may simply be an artifact of the positive manifold: people who are pay a little bit closer attention to the task also tend to be a little bit more outgoing (POSITIVE MANIFOLD CITATION).
- Self report relation to outcomes
  - Though the SPLT task did not show any strong correlations with self-report of the constructs that were hypothesized to underly both measures, it is possible that the self report measures only capture an underlying identiy that has little relation to actual behavior.
  - In order to acount of this possibility, we examined the association between relevant (self-reported) health-related behaviors and self-reported motives, as well as impulsivity and sensation seeking. 
  - Although both sources of information arise from self report, the health-related questions ask primarily about easily countable, and reasonably memorable experiences.
  - These behaviors were assessed _after_ the self-report trait questionnaires.
  - We found that the self-report scales were, in many cases, associated with relevant behaviors.
  - These findings, along with correlations between scales, provide some assurance of the validity of the instruments as measures of the named constructs.
  - In other words, we are assured that those participants who were not in long-term relationships, and who reported having more sexual partners in the last six months, also tended to have higher scores on the FSMI Mate-seeking and K-SRQ Sexual Relationships questionnaires.
  - Similarly, because considerable literature has linked adolescent and young adult popularity and status to alcohol consumption (CITE CITE CITE), it is reassuring the find that participants who report more days having had at least one drink, or having had 5 or more drinks in a session, also tend to score higher on the FSMI Status and K-SRQ Admiration scales.
- SPLT relation to outcomes
  - The relevant SPLT variables are not associated significantly with any of the assessed behavioral outcomes.
- Conclusion
  - Overall, there is some evidence that behavior on the SPLT task may be influenced to some degree by individual differences in motives.
  - There is also some evidence that behavioral outcomes may be related to motives as characterized by these instruments.
  - However, there is also evidence of considerable overlap between the variance in different scales.
  - This overlap is likely due to the various levels of description on which they opperate.
  - For example, the FSMI Mate-seeking and Status items seem to ask about social goals (finding a romantic partner, gaining status), whereas the K-SRQ Sexual Relationships and Admiration items ask the participant to consider their enjoyment of behaviors (flirting, receiving recognition) that are clearly related to those goals but are neither necessary nor sufficient for them. One exception is the Sociability subscale, which asks about attending social events, parties, and joining clubs. Unlike the other subscales in the K-SRQ, one could argue that variance on these items may be caused in part by a preferrence for a particular strategy for receiving admiration or status, in addition to being reinforced by socializing, per se.
  - The items on the UPPS-P are much more general, focusing on characterizing decision independently of the motivations behind them, and remaining agnostic about any kind of taxonomy of behavior. "I would like to go scuba diving," is just as meaningful an item for measuring Sensation Seeking as ". I like sports and games in which you have to choose your next move very quickly," or, "I quite enjoy taking risks." The cases that where associations were shown between the more focal motive variables and the behavior outcomes when controlling for UPPS-P subscales provide some evidence for the usefulness of taking into account this level of specificity. Though it is beyond the scope of this investigation, a more full exploration of the relation between these constructs, and description of their hierarchy, is certainly possible in these data, or in future studies.
