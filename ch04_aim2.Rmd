...
Risky sexual behavior is assessed by an item asking the participant to report on the frequency of a variety of safe sex practices.
...
In other simulations, $\Delta\text{MFI} > .012$ was roughly the cut-off for the 1\% level [@johnflournoy2018].
