...
Four parameters from the reinforcement learning model of SPLT behavior, $\epsilon, \rho, \xi, b$, and two summary statistics of optimal responding during the first and second half of the run, were correlated with all latent variables.
