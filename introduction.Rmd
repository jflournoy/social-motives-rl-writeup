...
These HRBs lead to what has been called the paradox of adolescence: although this is a period of robust physical health and increased mental ability, both morbidity and mortality increase [@dahl2004].
It can seem perplexing that adolescents engage in these HRBs despite evaluating the probability of uncertain events with accuracy similar to adults [@fischhoff2008], and demonstrating general accuracy (on occasion, somewhat excessive optimism) about the probability of future outcomes [@debruin2007;@fischhoff2000].
These findings become less paradoxical when considered from a functional-developmental perspective in which adolescents increase in sensation and novelty seeking.
...
Although the above literature acknowledges motivation, and measures related constructs, mate-seeking and status _motives_ are rarely or never a direct target of measurement.
...
Most work to date has focused on risk factors for unsafe sex unrelated to motivation [e.g., poverty, peer influence, parental monitoring; james2012;@santelli1992;@carlson2014].
...
*Aim 3a: Do close others perceive individual differences in motives that are reflected in motivational learning potentiation?* The importance of accurate interpersonal perception of status and mate-seeking motives may be exploited as a way to assess the construct validity of the learning paradigm, and also adds to literature on the validity of the FSM approach.
Correspondence between informant perceptions of individual differences in motive strength, and motive strength as elicited on the reinforcement learning task would support the external validity of this measure of motives. 

*Aim 3b: Is there agreement between close others and the self in perceptions of fundamental social motives?* Reports from informants with varying relationships to the target participant will allow exploration of the predicted importance of relationships to the motivations investigated here.
If motives are evolved responses to challenges arising from specific social relations, then actors in those relationship roles should be in the ideal position to both perceive and express those motives.
Differences in consensus by relationship type will help corroborate the FSM approach to the structure of motivation.
<!--stackedit_data:
eyJwcm9wZXJ0aWVzIjoiZXh0ZW5zaW9uczpcbiAgcHJlc2V0Oi
BnZm1cbiAgbWFya2Rvd246XG4gICAgYnJlYWtzOiBmYWxzZVxu
IiwiZGlzY3Vzc2lvbnMiOnsiUHRJMUcxSmI1NkNhd2hFUCI6ey
JzdGFydCI6NTA1LCJlbmQiOjY0MSwidGV4dCI6Ikl0IGNhbiBz
ZWVtIHBlcnBsZXhpbmcgdGhhdCBhZG9sZXNjZW50cyBlbmdhZ2
UgaW4gdGhlc2UgSFJCcyBkZXNwaXRlIGV2YWx1YXRpbmfigKYi
fX0sImNvbW1lbnRzIjp7IkhzaHFpWmkzVktUUFBkdVMiOnsiZG
lzY3Vzc2lvbklkIjoiUHRJMUcxSmI1NkNhd2hFUCIsInN1YiI6
IjExMTU1NDY2NDYxMzcxMjc1NTQ0NyIsInRleHQiOiJUZXN0aW
5nIGNvbW1lbnRzIiwiY3JlYXRlZCI6MTUyNTE5MjAxNDQ0NX19
LCJoaXN0b3J5IjpbLTEyNDQyOTM4NSwxNTY3OTY4OTM2LC0xMz
EzMDU3ODY0LC0xNDQ0MDY0MTFdfQ==
-->